...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Glasses AI — Find Your Perfect Frame by Face Shape" },
      {
        name: "description",
        content:
          "Detect your face shape from a photo or live camera and instantly see the eyeglass frames that suit you best. Runs privately in your browser.",
      },
      { property: "og:title", content: "Glasses AI — Find Your Perfect Frame by Face Shape" },
      {
        property: "og:description",
        content: "AI face shape analysis with real-time virtual glasses try-on, right in your browser.",
      },
